...
kotlin {
    ...
    val xcf = XCFramework("SerialTest")
    ...
    swiftExport {
        moduleName = "SerialTest"
        flattenPackage = "io.github.kotlinmania.serialtest"
    }

    android {
        namespace = "io.github.kotlinmania.serialtest"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "serial-test-kotlin", version.toString())

    pom {
        name.set("serial-test-kotlin")
        description.set("Kotlin Multiplatform port of palfrey/serial_tes - Allows for the creation of serialised Rust tests")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/serial-test-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/serial-test-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/serial-test-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/serial-test-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleSerialTestXCFramework",
    "assembleSerialTestDebugXCFramework",
    "assembleSerialTestReleaseXCFramework",
    "assembleDebugIosFatFrameworkForSerialTestXCFramework",
    "assembleReleaseIosFatFrameworkForSerialTestXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForSerialTestXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForSerialTestXCFramework",
    "assembleDebugMacosFatFrameworkForSerialTestXCFramework",
    "assembleReleaseMacosFatFrameworkForSerialTestXCFramework",
    "assembleDebugTvosFatFrameworkForSerialTestXCFramework",
    "assembleReleaseTvosFatFrameworkForSerialTestXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForSerialTestXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForSerialTestXCFramework",
    "assembleDebugWatchosFatFrameworkForSerialTestXCFramework",
    "assembleReleaseWatchosFatFrameworkForSerialTestXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForSerialTestXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForSerialTestXCFramework",
