// Kotlin callable wrapper for the upstream crate-root parallel attribute macro.
// No upstream Rust counterpart (Kotlin-specific wrapper around localParallelCore).
