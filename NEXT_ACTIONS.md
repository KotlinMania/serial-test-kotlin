...
- **Function parity:** 61/78 matched (target 91) — 78.2%
- **Class/type parity:** 6/6 matched (target 17) — 100.0%
- **Combined symbol parity:** 67/84 matched (target 108) — 79.8%
- **Average inline-code cosine:** 0.17 (function body across 7 matched files)
...
- **Target:** `serialtest.FileLock [ZERO]`
- **Similarity:** 0.00
- **Dependents:** 0
...
- **Target:** `serialtest.CodeLock [ZERO]`
- **Similarity:** 0.00
- **Dependents:** 0
...
- **Target:** `serialtest.FsParallelCore [ZERO]`
- **Similarity:** 0.00
- **Dependents:** 0
...
- **Target:** `serialtest.FsSerialCore [ZERO]`
- **Similarity:** 0.00
- **Dependents:** 0
...
- **Target:** `serialtest.SerialCodeLock [ZERO]`
- **Similarity:** 0.00
- **Dependents:** 0
- **Priority Score:** 610.0
