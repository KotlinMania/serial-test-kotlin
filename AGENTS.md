...
This file is the quick-reference operating contract for serial-test-kotlin. The longer
...
serial-test-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`serial_test`](https://crates.io/crates/serial_test). Upstream Rust is the behavioral oracle while the
